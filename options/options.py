...
def parse_args():
    ...
    parser.add_argument('--teacher_ckpt', type=str, default='./checkpoints/P/785_DWT.pt')
    #######################
    ...
    parser.add_argument('--scheduler', choices=['cos', 'step', 'exp', 'cyclic', 'lambda', 'None','mul'], default='cos')
    ...
    # for datasets
    parser.add_argument('--dataset', default='udc_dis', help='training dataset')
