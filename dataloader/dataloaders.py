...
from dataloader.disc_list import DiscListTrainValDataset, DiscListTestDataset
...
###################
if opt.udc_type == 'P':
    train_list = os.path.join('datasets', opt.dataset, 'Ptrain.txt')
    val_list = os.path.join('datasets', opt.dataset, 'Ptest.txt')
    print('You are using Poled data.')
elif opt.udc_type == 'T':
    train_list = os.path.join('datasets', opt.dataset, 'Ttrain.txt')
    val_list = os.path.join('datasets', opt.dataset, 'Ttest.txt')
    print('You are using Toled data.')
else:
    raise AssertionError('You need to specify udc type!')
